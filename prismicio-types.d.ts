...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Sans Image field in *Hero → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.sans_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  sans_image: prismic.ImageField<never>;
...
export interface SkyDiveSliceDefaultPrimary {
  ...
  flavor: prismic.SelectField<
    "lemonLime" | "grape" | "watermelon" | "blackCherry" | "strawberryLemonade",
    "filled"
  >;
}
